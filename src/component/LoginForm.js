...
import { auth, firesore } from "../database/firebase";
  ...
  if (!!user) {
    return (
      <div className="container-fluid">
          ...
          <div className="row mt-1">
            <div className="col-sm-10 mx-auto mt-3">
              ...
              <img
                ...
                alt="user"
                width="30%"
                className="rounded float-center mt-2"
                style={{ maxHeight: "300" }}
              />
            </div>
          </div>
        ...
        <div className="row mt-1">
          <div className="col-sm-10 mx-auto mt-3 text-center">
            <hr></hr>
      ...
      {message != "" ? (
        <div className="row mt-1">
          <div className="col-sm-6 mx-auto text-center">
            <div className="alert alert-warning p-2">{message}</div>
          </div>
        </div>
      ) : null}
          ...
          <div className="row card-footer flex-column-reverse flex-sm-row">
            ...
            {!registerMode ? (
              <div className="col-sm-6">
                <button
                  type="submit"
                  className="btn btn-btn-primary mt-1"
                  style={{ width: "100%" }}
